  ...
  try {
    const response = await axios.post(
      'https://dev-wtsepgno2gcc1wq8.us.auth0.com/oauth/token',
      {
        ...
        client_secret: 'K4LN8LWRFFuVAQ90SsgIeddd3RLXf67Prk0gg1RShnEPjzGX2Gd8_-g_346nmjpD',
    ...
    localStorage.setItem('ACCESS_TOKEN', JSON.stringify(response?.data?.access_token)); // Handle the response data here
  } catch (error) {
